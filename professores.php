<?php
  ...
  if ($nome) {
	$query="INSERT INTO tb_professores set 
	nome='{$nome}',
	endereco='{$endereco}',
	curso='{$curso}',
	nomepai='{$nomepai}',
...
<body>
	...
	<h1>Professor<small> Complete as colunas abaixo</small></h1>
	</div>
    <form class="form-horizontal" action="cadprofessor.php" method="GET" style="margin: 10px auto;">
	...
	<div class="form-group">
	<label for="sel1" class="col-sm-2 control-label">Professor do Curso:</label>
	<div class="col-sm-6">
	...
	<div class="page-header" style="text-align:center;">
	<a href="cadprofessor.php">
	<div class="botao">
	<p style="font-size: 40px;"><span class="glyphicon glyphicon-folder-open" aria-hidden="true"></span>     Professores Cadastrados</p>
	</div></a>
	</div>
	<div class="page-header" style="text-align:center;">
